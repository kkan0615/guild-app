export enum RouterNameEnum {
  ...
  GUILD_POST_BOARD_GROUP_CREATE_FORM = 'GUILD_POST_BOARD_GROUP_CREATE_FORM',
  GUILD_POST_BOARD_GROUP_UPDATE_FORM = 'GUILD_POST_BOARD_GROUP_UPDATE_FORM',
  GUILD_POST_BOARD_DETAIL = 'GUILD_POST_BOARD_DETAIL',
