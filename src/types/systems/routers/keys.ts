export enum RouterNameEnum {
  ...
  LOGOUT = 'Logout',
  /* Guild */
  GUILD_BASE_LAYOUT = 'GuildBaseLayout',
  /* Guild General */
  GENERAL_LAYOUT = 'GeneralLayout',
  GUILD_HOME = 'GuildHome',
  /* guild user */
  GUILD_USER_LAYOUT = 'GUILD_USER_LAYOUT',
  GUILD_USER_LIST = 'GUILD_USER_LIST',
  /* Guild calendar */
  GUILD_CALENDAR_LAYOUT = 'GUILD_CALENDAR_LAYOUT',
  GUILD_CALENDAR_MAIN = 'GUILD_CALENDAR_MAIN',
  GUILD_CALENDAR_CREATE_FORM = 'GUILD_CALENDAR_CREATE_FORM',
  GUILD_CALENDAR_UPDATE_FORM = 'GUILD_CALENDAR_UPDATE_FORM',
  /* Guild notice */
  GUILD_NOTICE_LAYOUT = 'GUILD_NOTICE_LAYOUT',
  GUILD_NOTICE_MAIN = 'GUILD_NOTICE_MAIN',
  GUILD_NOTICE_CREATE_FORM = 'GUILD_NOTICE_CREATE_FORM',
  GUILD_NOTICE_UPDATE_FORM = 'GUILD_NOTICE_UPDATE_FORM',
  /* Guild posts */
  GUILD_POST_LAYOUT = 'GUILD_POST_LAYOUT',
  GUILD_POST_MAIN = 'GUILD_POST_MAIN',
  GUILD_POST_BOARD_CREATE_FORM = 'GUILD_POST_BOARD_CREATE_FORM',
  GUILD_POST_BOARD_UPDATE_FORM = 'GUILD_POST_BOARD_UPDATE_FORM',
  GUILD_POST_DETAIL = 'GUILD_POST_DETAIL',
  GUILD_POST_CREATE_FORM = 'GUILD_NOTICE_CREATE_FORM',
  GUILD_POST_UPDATE_FORM = 'GUILD_NOTICE_UPDATE_FORM',
  /* Guild Admin */
